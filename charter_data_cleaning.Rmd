...
environment(myrsquared) <- asNamespace("plm")
myrsquared(r,dfp[fold[[1]],])
# trace(r.squared,edit=T)
# untrace(r.squared)
getAnywhere(r.squared)
  getAnywhere(pmodel.response.plm)
    getAnywhere(model.frame.pdata.frame)


model.frame(r,dfp[fold[[1]],])
trace(pmodel.response)
