...
ncessch_keeps = df[,.N,by=ncessch][N>=10,ncessch] %>% head(1280)
...
# calculate RMSE
sqrt(sum(regression$residuals^2)/(140-44))
sqrt(sum(regression2$residuals^2)/(140-44))
# show results
#d <- r$model %>% model.matrix %>% dimnames(); d[[2]]
# hatmat
# regression
```
